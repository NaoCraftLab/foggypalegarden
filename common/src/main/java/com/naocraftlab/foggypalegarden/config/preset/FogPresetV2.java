...
import com.naocraftlab.foggypalegarden.domain.model.FpgFogShape;
...
public final class FogPresetV2 extends FogPreset {
    ...
    public record Binding(
        ...
        public record Condition(
                ...
                Set<FpgDifficulty> difficultyIn,
        ...
        @Override
        public FpgFogShape shape() {
            return shape == null ? FpgFogShape.SPHERE : shape;
        }
