...
public final class ConfigFacade {
    ...
    @NotNull
    public List<FpgGameMode> noFogGameModes() {
        return mainConfig.getNoFogGameModes().stream().sorted().toList();
    }

    public boolean isNoFogGameMode(@NotNull FpgGameMode gameMode) {
        return mainConfig.getNoFogGameModes().contains(gameMode);
    }

    public boolean toggleNoFogGameMode(@NotNull FpgGameMode gameMode) {
